...
/datum/skillset/prom_psitherapist
	name = "Psi-therapist"
	initial_skills = list(
		/datum/skill/engineering = SKILL_LEVEL_TRAINED,
		/datum/skill/construction = SKILL_LEVEL_TRAINED,
...
/datum/skillset/prom_chief_engineer
	name = "Chief Engineer"
	initial_skills = list(
...
/datum/skillset/prom_research_director
...
/datum/skillset/prom_specialist
	name = "Specialist"
	initial_skills = list(
		/datum/skill/firearms = SKILL_LEVEL_TRAINED,
		/datum/skill/engineering = SKILL_LEVEL_TRAINED,
...
/datum/skillset/prom_logistics_officer
