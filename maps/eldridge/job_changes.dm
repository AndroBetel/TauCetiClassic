#define JOB_MODIFICATION_MAP_NAME "Eldridge Station"
...
/datum/job/assistant/New()
	...
	alt_titles = list(
		...
		"Hotel Employee" = /datum/outfit/job/assistant/hotel_employee,
		)
	...
	skillsets = list(
		...
		"Hotel Employee" = /datum/skillset/test_subject/waiter,
		)
