/mob/living/simple_animal/hostile/mimic/crate/maints
	health = 75
	maxHealth = 75
...
/mob/living/simple_animal/hostile/octopus
	...
	desc = "Weird monster from nearest gas giant, spotted migrating in Tau Ceti region. Uses it's long tentacles to throw different things at it's prey until it dies."
